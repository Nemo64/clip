...
export type VideoProps =
  { formats: VideoFormat[] }
  & Omit<Props<VideoFormat>, "options" | "getOptionValue" | "formatOptionLabel">;
export type AudioProps =
  { formats: AudioFormat[] }
  & Omit<Props<AudioFormat>, "options" | "getOptionValue" | "formatOptionLabel">;
  ...
  return (
    <Select {...props}
            ...
            formatOptionLabel={option => <>
              {option.preset === 'crf_1080p' && t('conversion.video_quality.crf_1080p')}
            ...
            formatOptionLabel={option => <>
              ...
              {option.preset?.startsWith('bitrate') && (
                !option.implausible
                  ...
                  : <div className="text-red-500 text-sm">{t('conversion.audio_quality.bitrate_implausible')}</div>
              )}
            </>}/>
  );
}
